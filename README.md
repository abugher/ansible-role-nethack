...
WARNING:  Old save files (and bones files, probably, if you keep those locally)
will be removed by the `make install` process, if they belong to the same major
and minor version of nethack that is being installed.  (Be prepared to lose
your saves for 3.6.6 if you install 3.6.7.)  You can set them aside manually
before an upgrade, at your discretion.
